...
def test_GUMH2():
    ...
    assert numpy.isclose(GUM0.mean, 127.732, rtol=0, atol=0.001) # Within 3-decimal places given in GUM
    assert numpy.isclose(GUM1.mean, 219.847, rtol=0, atol=0.001)
    assert numpy.isclose(GUM2.mean, 254.260, rtol=0, atol=0.001)
    assert numpy.isclose(GUM0.uncert, 0.071, rtol=0, atol=0.001)
    assert numpy.isclose(GUM1.uncert, 0.295, rtol=0, atol=0.001)
    assert numpy.isclose(GUM2.uncert, 0.236, rtol=0, atol=0.001)

    MC0 = u.out.R.mc
    MC1 = u.out.X.mc
    MC2 = u.out.Z.mc
    assert numpy.isclose(MC0.mean, 127.732, rtol=1E-5, atol=0.001) # Add some relative tolerance due to MC randomness
    assert numpy.isclose(MC1.mean, 219.847, rtol=1E-5, atol=0.001)
    assert numpy.isclose(MC2.mean, 254.260, rtol=1E-5, atol=0.001)
    assert numpy.isclose(MC0.uncert, 0.071, rtol=1E-5, atol=0.001)
    assert numpy.isclose(MC1.uncert, 0.295, rtol=1E-5, atol=0.001)
    assert numpy.isclose(MC2.uncert, 0.236, rtol=1E-5, atol=0.001)
...
def test_NIST6():
    ...
    assert numpy.isclose(GUM.mean, 1.7266E-5, rtol=0, atol=0.0001E-5)  # Same sigfigs as NIST NUM calculator.
    assert numpy.isclose(GUM.uncert, 1.76E-6, rtol=0, atol=0.01E-6)
    assert numpy.isclose(MC.mean, 1.7268E-5, rtol=1E-3, atol=0.0001E-5)
    assert numpy.isclose(MC.uncert, 1.74E-6, rtol=1E-2, atol=.1E-6)
...
def test_NIST6_fn():
    ...
    assert numpy.isclose(GUM.mean, 1.7266E-5, rtol=0, atol=0.0001E-5)  # Same sigfigs
    assert numpy.isclose(GUM.uncert, 1.76E-6, rtol=0, atol=0.01E-6)
    assert numpy.isclose(MC.mean, 1.7268E-5, rtol=1E-3, atol=0.0001E-5)
    assert numpy.isclose(MC.uncert, 1.74E-6, rtol=1E-2, atol=.1E-6)
...
def test_NIST10():
    ...
    assert numpy.isclose(GUM.mean, 5.67037E-8, rtol=0, atol=.00001E-8)
    assert numpy.isclose(GUM.uncert, 2.05E-13, rtol=0, atol=.01E-13)
    assert numpy.isclose(MC.mean, 5.67037E-8, rtol=1E-3, atol=.00001E-8)
    assert numpy.isclose(MC.uncert, 2.05E-13, rtol=1E-3, atol=.01E-13)
    low, hi, k = MC.expanded(.99)
    assert numpy.isclose(low[0], 5.67032E-8, rtol=1E-6, atol=.00001E-8) # 99% interval
    assert numpy.isclose(hi[0], 5.67043E-8, rtol=1E-6, atol=.00001E-8)
    low, hi, k = MC.expanded(.68)
    assert numpy.isclose(low[0], 5.67035E-8, rtol=1E-6, atol=.00001E-8) # 68% interval
    assert numpy.isclose(hi[0], 5.67039E-8, rtol=1E-6, atol=.00001E-8)
...
def test_NISTE3():
    ...
    # MC results
    assert numpy.isclose(MC.mean, 5.82, rtol=0, atol=.01)
    assert numpy.isclose(MC.uncert, 1.11, rtol=1, atol=.01)
    low, hi, k = MC.expanded(.95)
    assert numpy.isclose(low[0], 4.05, rtol=1E-3, atol=.01)
    assert numpy.isclose(hi[0], 8.39, rtol=1E-3, atol=.01)

    # GUM results
    assert numpy.isclose(GUM.mean, 5.69, rtol=0, atol=.01)
    assert numpy.isclose(GUM.uncert, 1.11, rtol=0, atol=.1)  # NIST Has some round-off error
...
def test_NISTE11():
    ...
    assert numpy.isclose(MC.mean, 30.043, rtol=0, atol=.001)
    assert numpy.isclose(MC.uncert, 0.0224, rtol=0, atol=.0005)
    assert numpy.isclose(low[0], 30.006, rtol=1E-3, atol=.001)
    assert numpy.isclose(hi[0], 30.081, rtol=1E-3, atol=.001)
...
def test_GUMSUP2():
    ...
    assert numpy.isclose(GUM0.mean, .001, atol=.0005)  # Magnitude
    assert numpy.isclose(GUM1.mean, 0.000, atol=.001)  # Phase
    assert numpy.isclose(GUM0.uncert, .010, atol=.001)
    assert numpy.isclose(GUM1.uncert, 10.000, atol=.001)
    assert numpy.isclose(MC0.mean, .013, atol=.0005)
    assert numpy.isclose(MC1.mean,  0, atol=.01)
    assert numpy.isclose(MC0.uncert, .007, atol=.0005)
    assert numpy.isclose(MC1.uncert, 1.744, atol=.002)
    ...
    assert numpy.isclose(GUM0.uncert, .010, atol=.001)
    assert numpy.isclose(GUM1.uncert, 10.000, atol=.001)
    assert numpy.isclose(MC0.mean, .012, atol=.0005)
    assert numpy.isclose(MC1.mean,  -.556, atol=.005)
    assert numpy.isclose(MC0.uncert, .008, atol=.0005)
    assert numpy.isclose(MC1.uncert, 1.599, atol=.002)
    ...
    MC0 = u.out.get_output(fidx=0, method='mc')
    MC1 = u.out.get_output(fidx=1, method='mc')
    assert numpy.isclose(GUM0.mean, .010, atol=.0005)  # Magnitude
    assert numpy.isclose(GUM1.mean, 0.000, atol=.001)  # Phase
    assert numpy.isclose(GUM0.uncert, .010, atol=.001)
    assert numpy.isclose(GUM1.uncert, 1.000, atol=.001)
    assert numpy.isclose(MC0.mean, .015, atol=.0005)
    assert numpy.isclose(MC1.mean,  -.343, atol=.005)
    assert numpy.isclose(MC0.uncert, .008, atol=.0005)
    assert numpy.isclose(MC1.uncert, .903, atol=.002)
...
def test_montecarlo():
    ...
    assert numpy.isclose(MC.mean, 0, atol=.005)
    assert numpy.isclose(MC.uncert, 2.0, atol=.005)
    assert numpy.isclose(hi[0], 3.92, atol=.005)
    assert numpy.isclose(low[0], -3.92, atol=.005)
    ...
    assert numpy.isclose(MC.mean, 0, atol=.005)
    assert numpy.isclose(MC.uncert, 2.0, atol=.005)
    assert numpy.isclose(hi[0], 3.88, atol=.005)
    assert numpy.isclose(low[0], -3.88, atol=.005)
...
def test_NPLlog():
    ...
    u.calculate()
    assert numpy.isclose(u.out.y.gum.mean[0], -.511, atol=.001)  # Results from Table 9.2
    assert numpy.isclose(u.out.y.gum.uncert[0], .481, atol=.001)
    assert numpy.isclose(u.out.y.mc.mean[0], -.665, atol=.001)
    assert numpy.isclose(u.out.y.mc.uncert[0], .606, atol=.001)

    # GUM expanded 95%
    p, k = u.out.y.gum.expanded(.95)
    assert numpy.isclose(u.out.y.gum.mean[0] + p, .432, atol=.001)
    ...
    assert numpy.isclose(mn, -1.895, atol=.001)
    assert numpy.isclose(mx, 0.095, atol=.001)
...
def test_XRF():
    ...
    u.calculate()
    assert numpy.isclose(u.out.yc.gum.uncert[0], .00494, atol=.00001)   # Slide 113 in "v2" version
    assert numpy.isclose(u.out.yc.gum.mean[0], .6967, atol=.0001)       # Slide 115
    assert numpy.isclose(u.out.yc.gum.degf, 27.7, atol=.5)              # Slide 117 (slides have some roundoff error)
    assert numpy.isclose(u.out.yc.gum.expanded(.95)[0], .0101, atol=.0001) # Slide 118
