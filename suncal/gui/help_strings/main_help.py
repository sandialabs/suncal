...
class MainHelp:
    ...
    def project_types():
        ...
        rpt.txt('- **Global Risk**: Compute average probability of false accept and false reject '
                'for a measurement\n'
                ...
                '- **All-in-one Measurement System**: Define a complete measurement system consisting '
