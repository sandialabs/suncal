...
class InsertCalcWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        glayout.addWidget(self.btnDataset, 0, 1)
        glayout.addWidget(self.btnCurve, 0, 2)
        glayout.addWidget(self.btnRisk, 1, 0)
        ...
        layout.addStretch()
        layout.addWidget(QtWidgets.QLabel('Select project component:'))
...
class MainGUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.pginsert.showhelp.connect(self.open_page_help)
