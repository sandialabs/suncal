...
class SettingsWidget(QtWidgets.QWidget):
    ...
    def __init__(self, fitcalc, parent=None):
        ...
        validator = QtGui.QIntValidator(1, 1E18)
...
class PageInputCurveFit(QtWidgets.QWidget):
    ...
    def load_data(self):
        ...
        if ok:
            ...
            self.table.xdates = False  # Data coming in is float, not date
...
class PageOutputCurveFit(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.cmbMCplot.addItems(['Histograms', 'Samples', 'Convergence'])
    ...
    def update(self):
        ...
        if self.outSelect.currentText() == 'Fit Plot':
            ...
            r += output.sympyeqn(self.output._baseoutputs[0].expr(subs=True)) + '\n\n'
            r += '### Goodness of Fit\n\n'
            ...
            elif self.cmbMCplot.currentText() == 'Convergence':
                out.plot_converge(fig=self.fig)
            else:
                out.plot_samples(fig=self.fig, inpts=params)

            r += output.sympyeqn(out.expr()) + '\n\n'
