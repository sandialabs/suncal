...
Settings are saved in an INI file to the location:
    (Windows) -- $APPDATA$/SandiaPSL/PSLUncertCalc.ini
    (Mac/Unix) -- ~/.config/SandiaPSL/PSLUncertCalc.ini
'''
...
class PgSettingsDlg(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.list.addItems(['General', 'Plot Style', 'Report Format', 'Distributions', 'Monte-Carlo', 'Expanded Unc.'])
...
if __name__ == '__main__':
    ...
    # run using: "python -m psluncert.gui.configmgr"
    import sys
