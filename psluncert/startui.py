...
from psluncert import gui
from psluncert.gui import gui_common
from psluncert import version
...
<font size=3>
<br>
Copyright 2019 National Technology & Engineering Solutions<br>of Sandia, LLC (NTESS).
...
painter.drawPixmap(10, 10, gui_common.get_logo(pixmap=True))
splash = QtWidgets.QSplashScreen(pixmap)
splash.showMessage(message, alignment=QtCore.Qt.AlignRight)
splash.show()
