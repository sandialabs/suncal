...
pandoc manual.md -N --toc --include-in-header header.tex --filter pandoc-fignos --variable subparagraph --variable geometry="margin=1in" --variable fontfamily=sans --filter pandoc-citeproc --bibliography=biblio.bib --csl=biblio.csl -o ../PSLUCmanual.pdf
...
cp ../PSLUCmanual.pdf ../../psluncert/gui/PSLUCmanual.pdf
